@extends('../layouts/admin/adminlayout', [
    'pagedata' => $pagedata,
    'title' =>'Previous Work Permit  - ' . $pagedata->site_name,
    'description' => '',
                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Previous Work Permit</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item">
                                                <a class="text-muted text-decoration-none" href="/admin">Home</a>
                                            </li>
                                            <li class="breadcrumb-item" aria-current="page">Work Permit</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
