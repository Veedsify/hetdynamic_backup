@extends('.../layouts/admin/adminlayout', [
    'pagedata' => $pagedata,
    'title' => 'Aboutpage Banner Configuration  - ' . $pagedata->site_name,
    'description' => '',
                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Update About Details</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item">
                                                <a class="text-muted text-decoration-none" href="/">Home</a>
                                            </li>
                                            <li class="breadcrumb-item" aria-current="page">About Details</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="about_banner_title"
                                                ...
                                                value="{{ old('about_banner_title') === null ? $data->about_banner_title : old('about_banner_title') }}">
                                        </div>
                                    </div>
