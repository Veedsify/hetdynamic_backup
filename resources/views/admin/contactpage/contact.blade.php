@extends('.../layouts/admin/adminlayout', [
    'pagedata' => $pagedata,
    'title' => 'Contact Configuration  - ' . $pagedata->site_name,
    'description' => '',
                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Update Contact Details</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-4">
                                            ...
                                            <input type="file" class="form-control" id="contact_banner_image"
                                                name="contact_banner_image" aria-describedby="emailHelp">
                                        </div>
                                    </div>
