                ...
                ">
                    ...
                    <tr>
                        <td align="center" valign="top" bgcolor="#FFFFFF">
                            ...
                            "
                                                    mc:edit="bm11-02">
                                                    <multiline>New Contact Request From
                                                                                    ...
                                                                                    <td align="left" valign="top">
                                                                                        <table width="490"
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="left"
                                                                                                    valign="top"
                                                                                                    style="font-family: 'Open Sans', Verdana, Arial; font-size: 16px; color: #000; font-weight: normal; line-height: 22px;"
                                                                                                    mc:edit="bm11-03">
                                                                                                    <p>Hi Admin, you've
                                                                                                        got a new mail
                                                                                                        request.</p>
                                                                                                    ...
                                                                                                    <br>
                                                                                                    <p><strong>Message:</strong><br>{{ $user->message }}
                                                                                                    </p>
                                                                                                    <br>
                                                                                                </td>
                                                                                            </tr>
                    ...
                    <tr>
                        <td height="55" align="center" valign="center"
                            ...
                            <multiline><a href="#" style="text-decoration: none; color: #000"><svg
                                        ...
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"
                                            stroke="#CCCCCC" stroke-width="0.397474"></g>
                                        <g id="SVGRepo_iconCarrier">
                                            <g>
                                                <path
                            ...
                            <multiline><a href="#" style="text-decoration: none; color: #000"><svg
                                        fill="#000000" height="26px" width="22px" version="1.1" id="Capa_1"
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
