            ...
            <td align="center" valign="top">
                ...
                ">
                            <table width="105" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td height="80" align="center" valign="center">&nbsp;</td>
                                </tr>
                                <tr>
                                    <td align="center" valign="center">
                                        <a href="#"><img editable="true" mc:edit="bm11-11"
                                                src="{{ asset($site_data->site_logo) }}" width="300" height="70"
                                                alt="" /></a>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td align="center" valign="top" bgcolor="#FFFFFF">
                            ...
                            "
                                                    mc:edit="bm11-05">
                                                    <multiline>Hi {{ explode(' ', $user->fullname)[0] }}</multiline>
                                                </td>
                                        ...
                                        "
                                                                            mc:edit="bm11-03">
                                                                            <multiline>
                                                                                We got you request, You can now reset
                                                                                your password!
                                                                            </multiline>
                                                                        </td>
                                                                    </tr>
                                        ...
                                        "
                                                                            ...
                                                                            <multiline>
                                                                                <b
                                                                                    style="font-size: 40px; letter-spacing: 10px; color: #000; font-weight: bold;">
                                                                                    {{ $code }}
                                                                                </b>
                                                                            </multiline>
                                                                        </td>
                                ...
                                <tr>
                                    <td align="left" valign="top">
                                        ...
                                        "
                                                                mc:edit="bm11-03">
                                                                <multiline>
                                                                    Just so you Know: You have 24 hours to pick your
                                                                    password. After that, you'll have to
                                                                    ask for a new one.
                                                                </multiline>
                                                            </td>
                                                        </tr>
                                        ...
                                        "
                                                                mc:edit="bm11-03">
                                                                <multiline>
                                                                    Didn't ask for a new password? You can ignore this
                                                                    email.
                                                                </multiline>
                                                            </td>
                                                        </tr>
                                        ...
                                        "
                                                                ...
                                                                <multiline>
                                                                    If you didn't authorize this, kindly ignore and
                                                                    contact our support immediately
                                                                    at <a href="mailto:support@Hetdynamic.com"
                                                                        style="color: #025908; text-decoration: underline;">

                                                                        support@Hetdynamic.com
                                                                    </a>
